public class PiecePlankton extends Piece implements Karener{

    private char symbol;
    private String teamColor;
    private int numKarens;
    private boolean hidden;
    private boolean original;


    @Override
    public  boolean validKarenPath (int fromRow,int fromColumn,
                                     int toRow,int toColumn)
    {
      if(fromRow<toRow&&toColumn==fromColumn||fromRow>toRow&&toColumn==fromColumn){
          return true;
      }else if(fromColumn<toColumn&&toRow==fromRow||fromColumn>toColumn&&toRow==fromRow){
          return true;
      }else{
          return false;
      }
    ...
    @Override
    public void setNumKarens(int numKarens)    {
        /**
