                ...
                if (oldSpace instanceof PiecePlankton) {
                    ...
                    for (int row = -2; row < 3; row++) {
                        for (int col = -2; col < 3; col++) {
                            if ( curr.board.inBounds(curRow + row,curColumn + col)&&!(squ[curRow + row][curColumn + col].isEmpty())) {
                                if (squ[curRow + row][curColumn + col].getPiece().getTeamColor() != oldSpace.getTeamColor()) {
                                    counter += 1;
                                }
                            }
                        }
