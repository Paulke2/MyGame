...
public class Controller {
    ...
    public GameS22 setUpGameModel(){
        ...
        piecesTeamA.add(new PieceEvilMinion('E',"Blu",1,
                1,4,false, true));
        piecesTeamA.add(new PiecePlankton('P',"Blu",0,
                false, true));
        ...
        piecesTeamB.add(new PieceEvilMinion('E',"Red",1,
                1,4,false, true));
        piecesTeamB.add(new PiecePlankton('P',"Red",0,
                false, true));
        // Create a team object
        // Create a team object
    ...
    public Controller() {
        /**
         * constructs Controller object, calling the setUpGameModel method to set up the game, sets up a TextView and
